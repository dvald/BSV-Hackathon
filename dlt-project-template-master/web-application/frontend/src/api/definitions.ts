...
export interface BsvStorageUploadResponse {
    /**
    ...
    /**
     * The UHRP URL of the uploaded file
     */
    uhrpUrl: string;
    ...
    /**
     * The storage bucket/category used
     */
    bucket: string;
...
export interface BsvStorageDownloadResponse {
    /**
...
export interface BsvStorageInfoResponse {
    /**
    ...
    /**
     * The UHRP URL of the file
     */
    uhrpUrl: string;
}

export interface BsvStorageConfigResponse {
    /**
     * Current storage mode (fs or bsv)
     */
    mode: string;
